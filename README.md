...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/0c6cc78d21b00edeae3ae0064dedbbdb56d53f54/L/LLVMExtra/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/maleadt/LLVM.jl.git (revision: `7a0d60b65d73d6a666a0ca1fef617452bab1e03f`)
